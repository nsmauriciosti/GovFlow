                  ...
                  <td className="px-6 py-4">
                    <div className="flex justify-center gap-2">
                      ...
                      <button 
                        ...
                        className={`p-2 rounded-lg transition-all ${isAdmin && user.id !== currentUser?.id ? 'text-slate-400 hover:text-rose-600 hover:bg-rose-50' : 'text-slate-200 cursor-not-allowed'}`}
                      >
